...
sshpass -p ${password} rsync -av --update ./PythonDev/* ${address}:~${full_dir}
sshpass -p ${password} rsync -av --update ./start.sh ${address}:~${full_dir}
sshpass -p ${password} rsync -av --update ./envs/* ${address}:~${full_dir}/envs/
